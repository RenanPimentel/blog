  ...
  return (
    <main className="wrapper">
      <div className="container">
        ...
        <p>
          Your privacy is important to us. It is <strong>Three Dots's</strong>
          policy to respect your privacy regarding any information we may
          collect from you across our website,
          <a href="http://localhost:3000">Three Dots</a>, and other sites we own
          and operate.
        </p>
        <p>
        ...
        <h2>
          <strong>Cookie Policy</strong> for <strong>Three Dots</strong>
        </h2>
        <p>
          This is the Cookie Policy for <strong>Three Dots</strong>, accessible
          from URL
        </p>
        ...
        <ul>
          ...
          {/* <li>
            ...
            site?:12{"}"}, will set cookies through our site which may be used
            to enhance your profile on their site or contribute to the data they
        ...
        <p>
          This policy is effective as of <strong>July</strong>
          <strong>2021</strong>.
        </p>
      </div>
    </main>
